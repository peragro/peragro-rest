...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileReference.project'
        db.add_column(u'damn_rest_filereference', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='files', to=orm['django_project.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileReference.project'
        db.delete_column(u'damn_rest_filereference', 'project_id')
