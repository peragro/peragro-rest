...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Path.project'
        db.add_column(u'damn_rest_path', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='paths', to=orm['django_project.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Path.project'
        db.delete_column(u'damn_rest_path', 'project_id')
