...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FileReference.mimetype'
        db.alter_column(u'damn_rest_filereference', 'mimetype', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'AssetReference.mimetype'
        db.alter_column(u'damn_rest_assetreference', 'mimetype', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FileReference.mimetype'
        raise RuntimeError("Cannot reverse this migration. 'FileReference.mimetype' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FileReference.mimetype'
        db.alter_column(u'damn_rest_filereference', 'mimetype', self.gf('django.db.models.fields.CharField')(max_length=255))

        # User chose to not deal with backwards NULL issues for 'AssetReference.mimetype'
        raise RuntimeError("Cannot reverse this migration. 'AssetReference.mimetype' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'AssetReference.mimetype'
        db.alter_column(u'damn_rest_assetreference', 'mimetype', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'damn_rest.filereference': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mimetype': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'path': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'files'", 'to': u"orm['damn_rest.Path']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'files'", 'to': u"orm['django_project.Project']"})
        },
        u'damn_rest.path': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['damn_rest.Path']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'paths'", 'to': u"orm['django_project.Project']"}),
