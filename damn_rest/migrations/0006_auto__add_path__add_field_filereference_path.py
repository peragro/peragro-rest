...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Path'
        db.create_table(u'damn_rest_path', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['damn_rest.Path'])),
            (u'lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal(u'damn_rest', ['Path'])

        # Adding field 'FileReference.path'
        db.add_column(u'damn_rest_filereference', 'path',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='files', to=orm['damn_rest.Path']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Path'
        db.delete_table(u'damn_rest_path')

        # Deleting field 'FileReference.path'
        db.delete_column(u'damn_rest_filereference', 'path_id')
